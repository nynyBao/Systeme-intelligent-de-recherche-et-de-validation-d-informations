...
%\AddToShipoutPicture*{\EtiquetteThese}
  \begin{titlepage}
  \centering
      \includegraphics[width=0.3\textwidth]{logo_Paris_Nanterre_couleur_RVB.png}
      \hfill
      $\ $\\
    ...
    {\bfseries Projet réalisé du 9/11/2025 au 21/12/2025}\\
    %	{\Large{\bfseries Spécialité doctorale ``\@specialite''}}\\
    \vspace{2cm}
    $\ $\\
\href{https://github.com/nynyBao/Systeme-intelligent-de-recherche-et-de-validation-d-informations}{Mon dépôt GitHub}.
    \vspace{0.5cm}
    $\ $\\
    \vspace{0.5cm}
    %	le \@date \\
